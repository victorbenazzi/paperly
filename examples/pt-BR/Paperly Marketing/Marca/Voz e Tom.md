...
A Paperly soa como uma amiga calma que por acaso é muito organizada.

## Princípios

1. **Palavras simples.** "Suas notas são arquivos numa pasta", não "um substrato de conhecimento local-first".
2. **Posse em primeiro lugar.** Toda mensagem reforça que a pessoa é dona dos próprios dados.
3. **Confiança quieta.** Sem hype, sem ponto de exclamação em copy de produto.
4. **Frases curtas.** Se a frase pede um fôlego no meio, divida em duas.
