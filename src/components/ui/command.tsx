...
function CommandDialog({
  ...
  /** cmdk client-side filtering; pass false when items arrive pre-filtered. */
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/* CommandInput/List are cmdk primitives: they need this Command
            root's context provider or they throw on mount. */}
